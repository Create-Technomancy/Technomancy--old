...
public class EnergyRepeaterItemRenderer extends AbstractFirearmItemRenderer {
	protected static final PartialModel COG = new PartialModel(Technomancy.TMLoc("item/energy_repeater/cog"));
	protected static final PartialModel RAILS = new PartialModel(Technomancy.TMLoc("item/energy_repeater/rails"));
	@Override
